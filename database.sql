...
(3, 'Round Rye', 'Bread', 45.00, 12, 'Traditional European sourdough rye loaf with rich earthy undertones and dense crumb.', 'assets/traditional-round-rye-bread-e1656042958429.png', 1),
(4, 'Yeast Custard', 'Bread', 40.00, 15, 'Sweet yeast bun filled with silky vanilla custard and spiced caramelized apple.', 'assets/yeast-bun-with-apple-and-custard-filling-e1656042965940.png', 1),
(5, 'Bially Sandwich', 'Bread', 50.00, 14, 'Classic bialy bread roll baked with savory roasted onion and savory seeds.', 'assets/breads-e1656042972619.png', 1),
(6, 'Bun Messes', 'Bread', 28.00, 25, 'Tender, pillowy brioche bun dusted with powdered sugar and natural sweetness.', 'assets/bun-e1656042983426.png', 1),
(7, 'Slice Bread', 'Bread', 60.00, 10, 'Daily sliced sandwich rye loaf made from whole grains and natural levain.', 'assets/rye-bread-slice-on-a-white-background--e1656042993568.png', 1),
(8, 'Bun Roll', 'Bread', 25.00, 30, 'Soft dinner roll with a golden finish, perfect with butter or jam.', 'assets/bun-1-e1656043014357.png', 1),
(9, 'Baguette', 'Bread', 25.00, 15, 'Classic French crusty artisan baguette baked fresh every morning.', 'assets/bread-e1656042861839-pqroqtezjh2g0607d0pphz5ddrx6ppa7b44no9oloo.png', 0),
(10, 'Croissant', 'Bread', 25.00, 16, 'Laminated, all-butter flaky French pastry with golden honeycomb layers.', 'assets/top-view-of-crescent-roll-with-poppy-seeds-on-white-background-e1656042946947.png', 0),
(11, 'Sourdough', 'Bread', 25.00, 12, 'Slow-fermented artisan sourdough loaf made with naturally cultured levain.', 'assets/assortment-of-artisan-bread-e1656042887278.png', 0),
(12, 'Ciabatta', 'Bread', 25.00, 14, 'Italian style white bread baked with virgin olive oil and fresh rosemary.', 'assets/italian-ciabatta-bread-on-black-slate-with-herbs-and-olives--e1656043199744 (1).png', 0),
(13, 'Brioche', 'Bread', 25.00, 18, 'Rich golden bread enriched with egg yolk and grass-fed butter.', 'assets/homemade-pumpkin-bread-e1656042901513.png', 0),
(14, 'Americano', 'Beverage', 55.00, 50, 'Rich double espresso diluted with hot mountain spring water.', 'assets/banana-bread-slice-of-cake-with-banana-and-blueberries-morning-breakfast-with-coffee-e1656043186302 (1).png', 0),
(15, 'Cold Brew', 'Beverage', 55.00, 40, 'Smooth, 18-hour cold steeped single-origin Arabica coffee.', 'assets/banana-bread-slice-of-cake-with-banana-and-blueberries-morning-breakfast-with-coffee-e1656043186302 (1).png', 0),
(16, 'Carbonated Drink', 'Beverage', 35.00, 45, 'Refreshing chilled sparkling fruit infusion.', 'assets/cheese-platter-with-nuts-honey-and-bread-square-crop-e1656043218344 (1).png', 0),
